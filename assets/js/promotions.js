...
function createPromoCard(promo) {
    ...
    return `
    <div class="group relative bg-white/5 border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-all duration-500 fade-in-up ${isSoldOut ? 'opacity-75 grayscale' : ''}">
        ...
        <div class="flex justify-between items-center">
            ...
            ${isSoldOut ? `
                <button disabled class="bg-gray-600 text-white w-24 h-8 rounded-full flex items-center justify-center text-xs font-bold cursor-not-allowed">
                    Sold Out
                </button>
            ` : `
